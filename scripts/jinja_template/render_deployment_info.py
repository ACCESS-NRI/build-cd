    ...
    for f in sorted(os.listdir(deployment_outputs_folder)):
        ...
        with open(os.path.join(deployment_outputs_folder, f), "r") as f_in:
            ...
            deployment = {
                ...
                "spack_git_hash": data["spack_git_hash"],
                "spack_config_version": data["spack_config_version"],
                "spack_config_git_hash": data["spack_config_git_hash"],
                "builtin_spack_packages_version": data["builtin_spack_packages_version"],
                "builtin_spack_packages_git_hash": data["builtin_spack_packages_git_hash"],
                "access_spack_packages_version": data["access_spack_packages_version"],
                "access_spack_packages_git_hash": data["access_spack_packages_git_hash"],
